...
function Home() {
  ...
  return (
    <>
      ...
      {/* 1st Section */}
      <div className='sm:px-24 px-8 py-28 bg-[#f8ebd5] dark:bg-gray-700'>
        {/* SVG element section */}
        ...
        {/* Search bar */}
        <div className={showSidebar ? 'sm:block hidden' : ''}>
          <div className={` w-full sm:w-3/5 m-auto mt-8`}>
            <form className='flex items-center'>
              ...
              <div className='relative  w-full'>
                <div className='absolute inset-y-0 left-0 flex items-center pl-5 pointer-events-none'>
                  <svg
                    aria-hidden='true'
                    className='w-7 h-7 text-gray-400 dark:text-gray-400'
                    fill='currentColor'
                    viewBox='0 0 20 20'
                    xmlns='http://www.w3.org/2000/svg'
                  >
                ...
                <input
                  ...
                  disabled
                  id='voice-search'
                  className='bg-[#f1e4ce] border border-gray-800 text-gray-900 text-lg rounded-full font-light focus:ring-blue-500 focus:border-blue-500 block w-full pl-16 p-4  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 placeholder-gray-700 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500'
                ...
                >
                  <svg
                    aria-hidden='true'
                    className='w-6 h-8 text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white'
                    fill='currentColor'
                    viewBox='0 0 20 20'
                    xmlns='http://www.w3.org/2000/svg'
                  >
        ...
        <div className='flex justify-center  mt-8'>
          <Link href='/67'>
            <button
              type='button'
              class='text-gray-900 bg-[#ece0ca] border hover:border-black border-gray-400 focus:outline-none hover:bg-[#ece0ca] focus:ring-4 focus:ring-gray-200 font-medium rounded-full text-xs  sm:text-sm px-2 sm:px-5 py-1.5 mr-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700'
            >
              Al Mulk
            </button>
          </Link>
        ...
        <div className='text-center '>
          <Link href='/page'>
            <button class='text-gray-900 text-center border border-gray-600 hover:bg-[#ece0ca] mt-20 focus:ring-4 focus:ring-gray-200 font-medium rounded-sm text-sm px-5 py-1.5  dark:bg-gray-600 dark:text-white  dark:border-gray-600 dark:hover:bg-gray-600 dark:hover:border-gray-400 dark:focus:ring-gray-700'>
